...
struct PlaylistDetailScreen: View {
    ...
    /// Called after the collection is copied, to show any messages or do additional work.
    var onCopy: (() -> Void)?
    ...
    @State private var showingClearUpdates = false
    ...
    var body: some View {
        ZStack {
            ...
            .onAppear {
                updatedAt = Helper.formatTimestamp(Double(collection.updatedAt))
            }
            ...
            .confirmationDialog(
                ...
                isPresented: $showingClearUpdates,
