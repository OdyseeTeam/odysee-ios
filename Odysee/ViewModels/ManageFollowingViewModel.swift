...
extension ManageFollowingScreen {
    ...
    class ViewModel: ObservableObject {
        ...
        static func isNotificationsDisabled(
            follow: Claim, following: Wallet.Following?
        ) -> Wallet.NotificationsDisabled {
            Wallet.isNotificationsDisabled(claim: follow, for: following)
        }
        ...
        func toggleNotificationsDisabled(follow: Claim) async -> Wallet.NotificationsDisabled {
            ...
            let new = !Self.isNotificationsDisabled(follow: follow, following: walletFollowing)
