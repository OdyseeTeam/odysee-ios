...
extension Method where ParamType: LbryMethodParams {
    func call(
        params: ParamType,
...
extension Method where ParamType: CommentMethodParams {
    func call(
        params: ParamType,
...
extension Method where ParamType: LbryioMethodParams {
    func call(
        params: ParamType,
        authTokenOverride: String? = nil,
    ) async throws -> ResultType {
        ...
        queryItems.append(URLQueryItem(name: LbryioMethods.authTokenParam, value: authToken))
...
protocol LbryMethodParams {}

enum LbryMethods {
    struct NilType: Codable, LbryMethodParams {}
...
enum CommentMethods {
    struct NilType: Codable, CommentMethodParams {}
