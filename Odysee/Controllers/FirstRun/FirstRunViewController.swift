...
class FirstRunViewController: UIViewController, FirstRunDelegate {
    ...
    func showCreateChannelView() {
        firstChannelVc = (
            storyboard?
                .instantiateViewController(identifier: "first_channel_vc") as! CreateChannelViewController
        )
    ...
    @IBAction func skipTapped(_ sender: UIButton) {
        ...
        if currentStep == FirstRunViewController.stepUserAccount || currentStep == FirstRunViewController
            .stepRewardVerification
        {
