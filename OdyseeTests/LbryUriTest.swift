...
// FIXME: primary/secondary should be implementation only
// Expose {stream,channel}*
struct Expected {
    var path: String?
...
//            "https://lbry.tv/",
        ...
        [
            ...
            // --- legacy
            ("test*1", Expected(streamName: "test*1")),  // FIXME: Not primaryClaimSequence?
